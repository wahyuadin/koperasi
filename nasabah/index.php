									...
									<div class="row">
										...
										<div class="col-7 col-stats">
											<div class="numbers">
												...
												<h4 class="card-title"><?= rupiah(nasabahSaldo($_SESSION['nasabah']->id_user)->SALDO); ?></h4>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row">
										...
										<div class="col-7 col-stats">
											<div class="numbers">
												...
												<h4 class="card-title"><?= rupiah(nasabahPemasukan($_SESSION['nasabah']->id_user)->SALDO)?></h4>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row">
										...
										<div class="col-7 col-stats">
											<div class="numbers">
												...
												<h4 class="card-title"><?= rupiah(nasabahPengeluaran($_SESSION['nasabah']->id_user)->SALDO)?></h4>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="card">
								...
								<table id="tabel-data" class="table table-bordered">
									...
									<?php
										...
										foreach (nasabahGetData($_SESSION['nasabah']->id_user) as $data) { ?>
											<tr>
												<th scope="row"><?= $no++?></th>
												<td><?= $data[2]?></td>
												<td><?= $data[3]?></td>

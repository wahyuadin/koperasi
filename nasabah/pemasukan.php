...
<div class="container">
                ...
                <div class="card-header">
                  ...
                  <?php } ?>
                  <h4 class="card-title">Total Pemasukan : <?= rupiah(nasabahPemasukan($_SESSION['nasabah']->id_user)->SALDO) ?></h4>
								</div>
								<div class="card-body">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="">
            <div class="form-group">
                <label for="formGroupExampleInput2">Nama Nasabah</label>
                <input type="text" class="form-control" name="nama" id="formGroupExampleInput2" placeholder="Nama Nasabah" required readonly value="<?= $_SESSION['nasabah']->nama?>">
            </div>
            <div class="form-group">
                <label for="formGroupExampleInput2">Nominal</label>
